...
class Run : public G4Run
{
 ...
 public:
  ...
  void EndOfRun();
  void AddProjection(G4int detectorID, G4double total, G4double prim, G4double scatter,
                     G4double totalCount, G4double primaryCount, G4double scatterCount);
  const G4DataVector& GetProjectionTotal() const { return fProjectionTotal; }
  const G4DataVector& GetProjectionPrim() const { return fProjectionPrim; }
  const G4DataVector& GetProjectionScatter() const { return fProjectionScatter; }
  const G4DataVector& GetCountTotal() const { return fCountTotal; }
  const G4DataVector& GetCountPrimary() const { return fCountPrimary; }
  const G4DataVector& GetCountScatter() const { return fCountScatter; }
 ...
 private:
  ...
  G4DataVector fEdep;
  G4DataVector fProjectionTotal;
  G4DataVector fProjectionPrim;
  G4DataVector fProjectionScatter;
  G4DataVector fCountTotal;
  G4DataVector fCountPrimary;
  G4DataVector fCountScatter;
};
